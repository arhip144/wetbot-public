const { EmbedBuilder, ButtonBuilder, ActionRowBuilder, ButtonStyle, TextInputStyle, TextInputBuilder, ModalBuilder, InteractionType, StringSelectMenuBuilder, Collection, RoleSelectMenuBuilder, ApplicationCommandOptionType, LabelBuilder } = require("discord.js")
...
module.exports = {
    ...
    run: async (client, interaction, args) => {
        ...
        if (!interaction.isChatInputCommand()) {
            if (interaction.isStringSelectMenu()) {
                ...
                if (interaction.values[0] === "name, description, image, color") {
                    ...
                    const errors = []
                    if (!quest.enable) {
                        if (!quest.targets.length) errors.push(`${client.language({ textId: `Отсутствует задача`, guildId: interaction.guildId, locale: interaction.locale })}`)
                        ...
                        if (interaction2 && interaction2.isModalSubmit()) {
                            ...
                            if (isNaN(+modalArgs.amount)) {
                                ...
                                if (modalArgs.amount < 0 || modalArgs.amount > 100000000000) {
                                    ...
                                    if (reward) {
                                        if (modalArgs.amount === 0) quest.rewards = quest.rewards.filter(e => e.id !== id && e.type !== type)
                    ...
                    if (selectMenuInteraction) {
                            ...
                            new LabelBuilder()
                                ...
                                .setTextInputComponent(
                                    new TextInputBuilder()
                                        ...
                                        .setStyle(TextInputStyle.Short)
                                        .setRequired(false)
                                        .setPlaceholder(`${client.language({ textId: type === "message" ? `${client.language({ textId: `ID канала`, guildId: interaction.guildId, locale: interaction.locale })}` : type === "quests" ? `${client.language({ textId: `ID квеста`, guildId: interaction.guildId, locale: interaction.locale })}` : type === "like" ? `${client.language({ textId: `ID пользователя`, guildId: interaction.guildId, locale: interaction.locale })}` : type === "fishing" || type === "mining" || type === "marketplace" || type === "itemsOpened" || type === "itemsReceived" || type === "itemsCrafted" || type === "itemsUsed" || type === "itemsBoughtInShop" || type === "itemsBoughtOnMarket" || type === "itemsSold" || type === "drop" || type === "transfer" ? `${client.language({ textId: `Название предмета`, guildId: interaction.guildId, locale: interaction.locale })}` : type === "wormholesSpawned" ? `${client.language({ textId: `ID червоточины`, guildId: interaction.guildId, locale: interaction.locale })}` : type === "UsedPromocode" ? `${client.language({ textId: `Код промокода`, guildId: interaction.guildId, locale: interaction.locale })}` : ``, guildId: selectMenuInteraction.guildId, locale: selectMenuInteraction.locale })}`)
                                )
                        )
                        const modal = new ModalBuilder()
                        ...
                        if (modalInteraction && modalInteraction.type === InteractionType.ModalSubmit) {
                            ...
                            if (!isNaN(+modalArgs.amount) && +modalArgs.amount > 0) {
                                if (quest.targets.length < 5) {
                                    let object
                                    if (modalArgs.object?.length && (type === "fishing" || type === "mining" || type === "marketplace" || type === "itemsOpened" || type === "itemsReceived" || type === "itemsCrafted" || type === "itemsUsed" || type === "itemsBoughtInShop" || type === "itemsBoughtOnMarket" || type === "itemsSold" || type === "drop" || type === "transfer")) {
                    ...
                    const row = new ActionRowBuilder().addComponents([
                        new StringSelectMenuBuilder().setCustomId(`submit editTarget ${interaction.id}`).setOptions(options).setPlaceholder(`${client.language({ textId: `Выбери задачу`, guildId: interaction.guildId, locale: interaction.locale })}`)
                    ])
                    ...
                    if (selectMenuInteraction) {
                        ...
                        if (target.type === "message" || target.type === "like" || target.type === "fishing" || target.type === "mining" || target.type === "wormhole" || target.type === "quests" || target.type === "marketplace" || target.type === "itemsOpened" || target.type === "wormholesSpawned" || target.type === "itemsReceived" || target.type === "itemsCrafted" || target.type === "itemsUsed" || target.type === "itemsBoughtInShop" || target.type === "itemsBoughtOnMarket" || target.type === "itemsSold" || target.type === "drop" || target.type === "transfer" || target.type === "UsedPromocode") components.push(
                            new ActionRowBuilder()
                                .addComponents(new TextInputBuilder()
                                .setCustomId("object")
                                .setLabel(client.language({ textId: `Объект задачи (не обязательно)`, guildId: interaction.guildId, locale: interaction.locale }))
                                .setStyle(TextInputStyle.Short)
                                .setRequired(false)
                                .setPlaceholder(`${client.language({ textId: target.type === "message" ? `${client.language({ textId: `ID канала`, guildId: interaction.guildId, locale: interaction.locale })}` : target.type === "quests" ? `${client.language({ textId: `ID квеста`, guildId: interaction.guildId, locale: interaction.locale })}` : target.type === "like" ? `${client.language({ textId: `ID пользователя`, guildId: interaction.guildId, locale: interaction.locale })}` : target.type === "fishing" || target.type === "mining" || target.type === "marketplace" || target.type === "itemsOpened" || target.type === "itemsReceived" || target.type === "itemsCrafted" || target.type === "itemsUsed" || target.type === "itemsBoughtInShop" || target.type === "itemsBoughtOnMarket" || target.type === "itemsSold" || target.type === "drop" || target.type === "transfer" ? `${client.language({ textId: `Название предмета`, guildId: interaction.guildId, locale: interaction.locale })}` : target.type === "wormholesSpawned" ? `${client.language({ textId: `ID червоточины`, guildId: interaction.guildId, locale: interaction.locale })}` : target.type === "UsedPromocode" ? `${client.language({ textId: `Код промокода`, guildId: interaction.guildId, locale: interaction.locale })}` : ``, guildId: selectMenuInteraction.guildId, locale: selectMenuInteraction.locale })}`))
                        )
                        const modal = new ModalBuilder()
                        ...
                        if (modalInteraction && modalInteraction.type === InteractionType.ModalSubmit) {
                            ...
                            modalInteraction.fields.fields.each(field => modalArgs[field.customId] = field.value)
                            let object
                            if (modalArgs.object?.length && (target.type === "fishing" || target.type === "mining" || target.type === "marketplace" || target.type === "itemsOpened" || target.type === "itemsReceived" || target.type === "itemsCrafted" || target.type === "itemsUsed" || target.type === "itemsBoughtInShop" ||  target.type === "itemsBoughtOnMarket" || target.type === "itemsSold" || target.type === "drop" || target.type === "transfer")) {
                    ...
                    if (interaction.values[0] === "clearProgress") {
                        ...
                        return interaction.reply({ content: `${client.language({ textId: `Прогресс квеста`, guildId: interaction.guildId, locale: interaction.locale })} ${await client.functions.getEmoji(quest.emoji)}**${quest.name}** ${client.language({ textId: `был очищен у`, guildId: interaction.guildId, locale: interaction.locale })} ${totalMembers} ${client.language({ textId: `пользователей`, guildId: interaction.guildId, locale: interaction.locale })}`, flags: ["Ephemeral"] })
                    }
                }
            } else
        ...
        if (quest.daily) {
            ...
            untilTime += `\nдо <t:${Math.round(end_date.valueOf()/1000)}>`
        ...
        const row = new ActionRowBuilder().addComponents([
            new StringSelectMenuBuilder().setCustomId(`qst{${quest.questID}}cmd{manager-quests}usr{${interaction.user.id}}type`).setOptions([
                {
        ...
        options.push(
            {
                label: `${client.language({ textId: `Добавить/удалить награду`, guildId: interaction.guildId, locale: interaction.locale })}`,
        ...
        const row2 = new ActionRowBuilder().addComponents([
            new StringSelectMenuBuilder().setCustomId(`qst{${quest.questID}}cmd{manager-quests}usr{${interaction.user.id}}`).setOptions(options).setPlaceholder(`${client.language({ textId: `Редактировать`, guildId: interaction.guildId, locale: interaction.locale })}...`)
        ])
        const row3 = new ActionRowBuilder().addComponents([
            new StringSelectMenuBuilder().setCustomId(`qst{${quest.questID}}cmd{manager-quests}usr{${interaction.user.id}}actions`).setOptions([
                {
