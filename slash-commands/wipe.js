...
module.exports = {
    ...
    run: async (client, interaction, args) => {
        ...
        const menu_options = [
            ...
            { emoji: client.config.emojis.invite, label: `${client.language({ textId: `${client.language({ textId: `Приглашения`, guildId: interaction.guildId, locale: interaction.locale })}`, guildId: interaction.guildId, locale: interaction.locale })}`, value: `invites`, description: `${client.language({ textId: `Очистит все приглашения пользователей`, guildId: interaction.guildId, locale: interaction.locale })}` },
